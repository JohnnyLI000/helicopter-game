...
/**
 * Class for a simple camera that rotates around the point of view using mouse
 * dragging.
 *
...
public class Camera implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void updateLocaiton(float anglesDelta, float xp, float yp, float zp) {
        this.setLookAt(xp, yp, zp);
    ...
    public void draw(GL2 gl) {
        ...
        glu.gluLookAt(
                camX + lookAt[0], camY + lookAt[1], camZ + lookAt[2], // eye // 
                lookAt[0], lookAt[1], lookAt[2], // center
                0, 1, 0);                        // up
        // System.out.println(camX);
        gl.glRotated(-anglesDelta, 0, 1, 0);
...
//                System.out.println("oldMousepos "+ oldMousePos.x);
//                System.out.println(p.x - oldMousePos.x);
//                
